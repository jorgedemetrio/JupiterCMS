...
public abstract class BaseServiceException extends BaseException {
    ...
    public BaseServiceException(final Exception ex, final HttpStatus statusParam, final String codeParam, final String descricaoParam) {
        super(ex);
        this.status = statusParam;
        this.codigo = codeParam;
    ...
    public BaseServiceException(final Exception ex, final String message, final HttpStatus statusParam, final String codeParam) {
        super(message, ex);
        this.status = statusParam;
        this.codigo = codeParam;
        this.descricao = message;
    ...
    public BaseServiceException(final Exception ex, final String message, final HttpStatus statusParam, final String codeParam, final String descricaoParam) {
        super(message, ex);
        this.status = statusParam;
        this.codigo = codeParam;
        this.descricao = descricaoParam;
    ...
    public BaseServiceException(final String message, final HttpStatus statusParam, final String codeParam, final String descricaoParam) {
        super(message);
        this.status = statusParam;
        this.codigo = codeParam;
        this.descricao = descricaoParam;
